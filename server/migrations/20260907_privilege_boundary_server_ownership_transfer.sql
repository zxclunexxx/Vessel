-- Ownership transfer is invoked by a JWT-protected Edge Function.
-- Keep the SECURITY DEFINER RPC unavailable to browser roles.
drop function if exists public.vessel_transfer_server_ownership(uuid,uuid);
